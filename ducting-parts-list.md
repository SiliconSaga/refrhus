...
- **Corrections to the model have tended to raise the load, not lower it**, and every gap still open points the same way. Today's figure reads as a floor rather than a midpoint.
